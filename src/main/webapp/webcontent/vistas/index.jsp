...
<main>
        ...
        <div class="position-absolute text-end col-md-6 col-12 text-light px-5">
            ...
            <div class="pt-1 d-grid gap-2 d-md-block">
                ...
                <button onclick="location.href='tickets.jsp'" type="button"
                        class="btn colorverde text-light btn-success">Comprar tickets
                </button>
            </div>
        </div>
    </div>
    ...
    <section id="orador">
        ...
        <h2 class="text-center text-uppercase">Oradores
        </h2>
    </section>
                ...
                <div class="card h-100" style="width: 18rem">
                    ...
                    <div class="card-body text-start">
                        ...
                        <p class="card-text">
                            ...
                            Delectus quisquam dolorum accusamus dicta necessitatibus neque
                            ullam dolores id, voluptatum natus!
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100" style="width: 18rem">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            nisi quis impedit consectetur consequuntur ducimus repellat
                            perferendis accusantium itaque sed!
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100" style="width: 18rem">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            maiores eligendi sequi, quis assumenda dignissimos dicta
                            veniam saepe beatae animi!
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="lugarfecha" class="container-fluid p-0 d-flex gap-1 text-white mt-4 align-items-stretch">
        ...
        <div class="col col-lg-6  col-md-12 col-sm-12 bg-dark p-3">
            ...
            <p class="card-text">
                Buenos Aires es la provincia y la localidad más grande de Argentina.
                En los Estados Unidos, Honolulu es la más sureña de entre
    ...
    <section id="serorador">
        ...
        <div class="d-flex justify-content-center">
            <div class="w-auto">
                <p class="mb-1 text-small">Anotate como orador para dar una <a class="text-black" href="#">charla
