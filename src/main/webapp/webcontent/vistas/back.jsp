            ...
            <div class="row">
                ...
                <%
                    ...
                    for (int i = 0 ; i < resultado.size() ; i++){
                        String rutaEliminar = "FontController?accion=eliminar&id=" + resultado.get(i).getId();
                        String tipoTicket;

                        switch (resultado.get(i).getTipo_ticket()){
                            case 1: tipoTicket = "Estudiante";
                            break;

                            case 2: tipoTicket = "Trainee";
                            break;

                            case 3: tipoTicket = "Junior";
                            break;
                        }
                %>
                <tr>
