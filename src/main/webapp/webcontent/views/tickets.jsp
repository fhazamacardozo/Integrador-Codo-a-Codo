...
<head>
    ...
    <title>IntegradorFront tickets</title>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link link-compra">Comprar tickets</a>
                        </li>
                    </ul>
        ...
        <div class="d-flex justify-content-center">
            <div class="w-auto">
                <form class="w-100">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control bg-primary-subtle" id="inputTotal"
                               value="Total a pagar: $" disabled>
                    </div>
